...
class NUCLA_CrossView(Dataset):
    ...
    def __init__(self, root_list, dataType, sampling, phase, T, maskType, setup,nClip):
        ...
        self.data_root = '/data/datasets/N-UCLA_MA_3D/multiview_action'
        self.dataType = dataType
        self.sampling = sampling
        self.maskType = maskType
        cam = '1,2,3' 
        if self.dataType == '2D':
            self.root_skeleton = '/data/datasets/N-UCLA_MA_3D/openpose_est'
        else:
            # self.root_skeleton = '/data/N-UCLA_MA_3D/skeletons_3d'
            self.root_skeleton = '/data/datasets/N-UCLA_MA_3D/VideoPose3D_est/3d_est'
